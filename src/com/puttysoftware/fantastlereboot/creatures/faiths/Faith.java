...
public final class Faith {
    ...
    public int getFaithAdjustedDamage(final int otherFaithID, final int rawDamage) {
	return FaithManager.getFaithAdjustedDamage(otherFaithID, this.faithID, rawDamage);
    }
