...
public class RaceConstants {
    ...
    public static final String[] NAMES = { "Cyborg", "Demon", "Dwarf", "Eagle", "Elf", "Ghost", "Gnome", "Goblin",
	    "Human", "Lizard", "Mush", "Orc", "Penguin", "Pixie", "Robot", "Shade", "Slime", "Troll", "Turtle",
	    "Wolf" };
    private static final double[] LOOKUP_TABLE = { 0.5, 0.54, 0.58, 0.63, 0.67, 0.71, 0.75, 0.79, 0.83, 0.88, 0.92,
	    0.96, 1.0, 1.08, 1.17, 1.25, 1.33, 1.42, 1.5, 1.58, 1.67, 1.75, 1.83, 1.92, 2.0 };
