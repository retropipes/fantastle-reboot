...
public class PartyManager {
    ...
    private static final String[] buttonNames = new String[] { "Done", "Create", "Pick" };
	...
	final int autoResponse = CommonDialogs.showCustomDialogWithDefault("How should the party be assembled?",
		"Create Party", autoButtons, autoButtons[0]);
	final boolean autoCreate = autoResponse != 1;
	if (autoCreate) {
	    // Automatically assemble a party
	    final ArrayList<Integer> toPick = new ArrayList<>();
		...
		if (pickMembers != null && picksLeft > 0) {
		    ...
		    final int pickMax = toPick.size() - 1;
		    final int pickIndex = RandomRange.generate(0, pickMax);
		    final int picked = toPick.get(pickIndex);
		    ...
		    pc = PartyManager.getNewPCInstance(ii, r, j, f, n, af, new AvatarImageModel(af, as, ah));
		...
		if (mem >= regLen) {
		    ...
		    final int response = CommonDialogs.showCustomDialogWithDefault("Pick, Create, or Done?",
			    "Create Party", PartyManager.buttonNames, PartyManager.buttonNames[2]);
		    if (response == 2) {
	...
	final int givenIndex = RandomRange.generate(0, PartyManager.givenNames.length - 1);
	final int familyIndex = RandomRange.generate(0, PartyManager.familyNames.length - 1);
	return PartyManager.givenNames[givenIndex] + " " + PartyManager.familyNames[familyIndex];
    }
    ...
    public static PartyMember getNewPCInstance(final ItemInventory ii, final int r, final int j, final int f,
	...
	return new PartyMember(ii, race, job, faith, n, af, model);
    }
	...
	final String name = CommonDialogs.showTextInputDialogWithDefault("Character Name", "Create Character",
	...
	if (name != null) {
		...
		if (caste != null) {
		    ...
		    if (faith != null) {
			final int avatarFamily = PartyManager.pickAvatarFamily(randomSkin, randomHair);
			if (avatarFamily != CommonDialogs.CANCEL) {
			    final int avatarSkin = PartyManager.pickAvatarSkinColor(avatarFamily, randomHair);
			    if (avatarSkin != CommonDialogs.CANCEL) {
				final int avatarHair = PartyManager.pickAvatarHairColor(avatarFamily, avatarSkin);
				if (avatarHair != CommonDialogs.CANCEL) {
				    final ItemInventory ii = new ItemInventory();
				    return new PartyMember(ii, race, caste, faith, name, avatarFamily,
					    new AvatarImageModel(avatarFamily, avatarSkin, avatarHair));
				}
			    }
			}
		    }
    ...
    private static int pickAvatarFamily(final int randomSkinID, final int randomHairID) {
	...
	final BufferedImageIcon[] input = new BufferedImageIcon[] {
		AvatarImageLoader.load(0, new AvatarImageModel(0, randomSkinID, randomHairID).getRules()),
		AvatarImageLoader.load(0, new AvatarImageModel(1, randomSkinID, randomHairID).getRules()),
		AvatarImageLoader.load(0, new AvatarImageModel(2, randomSkinID, randomHairID).getRules()),
		AvatarImageLoader.load(0, new AvatarImageModel(3, randomSkinID, randomHairID).getRules()),
		AvatarImageLoader.load(0, new AvatarImageModel(4, randomSkinID, randomHairID).getRules()),
		AvatarImageLoader.load(0, new AvatarImageModel(5, randomSkinID, randomHairID).getRules()) };
	final String[] descriptions = new String[] { "Green", "Red", "Yellow", "Cyan", "Pink", "Blue" };
	return CommonDialogs.showImageListWithDescDialog(labelText, title, input, 0, descriptions[0], descriptions);
    }

    private static int pickAvatarSkinColor(final int familyID, final int randomHairID) {
	final String labelText = "Avatar Skin Colors";
	final String title = "Pick Avatar Skin Color";
	final BufferedImageIcon[] input = new BufferedImageIcon[] {
		AvatarImageLoader.load(0, new AvatarImageModel(familyID, 0, randomHairID).getRules()),
		AvatarImageLoader.load(0, new AvatarImageModel(familyID, 1, randomHairID).getRules()),
		AvatarImageLoader.load(0, new AvatarImageModel(familyID, 2, randomHairID).getRules()),
		AvatarImageLoader.load(0, new AvatarImageModel(familyID, 3, randomHairID).getRules()),
		AvatarImageLoader.load(0, new AvatarImageModel(familyID, 4, randomHairID).getRules()),
		AvatarImageLoader.load(0, new AvatarImageModel(familyID, 5, randomHairID).getRules()),
		AvatarImageLoader.load(0, new AvatarImageModel(familyID, 6, randomHairID).getRules()),
		AvatarImageLoader.load(0, new AvatarImageModel(familyID, 7, randomHairID).getRules()),
		AvatarImageLoader.load(0, new AvatarImageModel(familyID, 8, randomHairID).getRules()),
		AvatarImageLoader.load(0, new AvatarImageModel(familyID, 9, randomHairID).getRules()) };
	final String[] descriptions = new String[] { "Darkest", "Darker", "Dark", "Mildly Dark", "Slightly Dark",
		"Slightly Light", "Mildly Light", "Light", "Lighter", "Lightest" };
	return CommonDialogs.showImageListWithDescDialog(labelText, title, input, 0, descriptions[0], descriptions);
    }
	...
	final BufferedImageIcon[] input = new BufferedImageIcon[] {
		AvatarImageLoader.load(0, new AvatarImageModel(familyID, skinID, 0).getRules()),
		AvatarImageLoader.load(0, new AvatarImageModel(familyID, skinID, 1).getRules()),
		AvatarImageLoader.load(0, new AvatarImageModel(familyID, skinID, 2).getRules()),
		AvatarImageLoader.load(0, new AvatarImageModel(familyID, skinID, 3).getRules()),
		AvatarImageLoader.load(0, new AvatarImageModel(familyID, skinID, 4).getRules()),
		AvatarImageLoader.load(0, new AvatarImageModel(familyID, skinID, 5).getRules()),
		AvatarImageLoader.load(0, new AvatarImageModel(familyID, skinID, 6).getRules()),
		AvatarImageLoader.load(0, new AvatarImageModel(familyID, skinID, 7).getRules()),
		AvatarImageLoader.load(0, new AvatarImageModel(familyID, skinID, 8).getRules()),
		AvatarImageLoader.load(0, new AvatarImageModel(familyID, skinID, 9).getRules()) };
	final String[] descriptions = new String[] { "Black", "Dark Gray", "Dark Brown", "Light Brown", "Red",
		"Light Gray", "Dark Yellow", "Yellow", "Tan", "Bright Yellow" };
	return CommonDialogs.showImageListWithDescDialog(labelText, title, input, 0, descriptions[0], descriptions);
    }
