...
public class BossMonster extends Creature {
    ...
    // Constructors
    BossMonster() {
	super(new ItemInventory(), Creature.TEAM_BOSS, FaithManager.getFaith(BossMonster.FAITH_ID),
		JobManager.getJob(BossMonster.JOB_ID), RaceManager.getRace(BossMonster.RACE_ID));
