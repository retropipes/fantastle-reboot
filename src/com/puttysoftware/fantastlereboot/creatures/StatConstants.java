...
public class StatConstants {
    ...
    // Names
    public static final String[] STAT_NAMES = { "Strength", "Block", "Agility", "Vitality", "Intelligence", "Luck",
	    "Current HP", "Current MP", "Gold", "Level", "Attacks Per Round", "Spells Per Round", "Load", "Maximum HP",
	    "Maximum MP", "Attack", "Defense", "Speed", "Hit", "Evade", "Capacity", "Maximum Level", "Fumble Chance" }; // NO_UCD
