...
public class ItemInventory {
    ...
    public void equipOneHandedWeapon(final Creature pc, final Equipment ei, final boolean useFirst,
    ...
    public void equipTwoHandedWeapon(final Creature pc, final Equipment ei, final boolean playSound) {
	// Fix character load, changing weapons
	if (this.equipment[EquipmentSlotConstants.SLOT_MAINHAND] != null) {
	    pc.offsetLoad(-this.equipment[EquipmentSlotConstants.SLOT_MAINHAND].getEffectiveWeight());
	}
    ...
    public void equipArmor(final Creature pc, final Equipment ei, final boolean playSound) {
	// Check for socks
