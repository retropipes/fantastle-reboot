...
public class WeaponConstants {
    // Constants
    private static final String[] WEAPON_1H = { "Dagger", "Club", "Scimitar", "Boomerang", "Javelin", "Grenade", "Whip",
	    "Crossbow", "Dart", "Sword", "Lock", "Fists", "Throwing Stars", "Pebbles", "Lockpicks", "Gun", "Flail",
	    "Hammer", "Wand", "Voice" };
    private static final String[] WEAPON_2H = { "Longsword", "Mace", "Staff", "Slingshot", "Spear", "Bazooka",
	    "Catapult", "Bow", "Boulder", "Axe", "Key", "Feet", "Halberd", "Lance", "Door", "Cannon", "Battering Ram",
	    "Laser", "Scythe", "Dance" };
