...
public class ArmorConstants {
    private static final String[] ARMOR = { "Helmet", "Necklace", "", "Shield", "Robe", "Cape", "Shirt", "Bracers",
	    "Gloves", "Ring", "Belt", "Pants", "Boots" };
    private static final String[] ARMOR_CHOICES = { "Helmet", "Necklace", "Shield", "Robe", "Cape", "Shirt", "Bracers",
	    "Gloves", "Ring", "Belt", "Pants", "Boots" };
