...
public class Equipment extends Item {
    ...
    // Constructors
    private Equipment(final Item i, final int equipCategory, final int newMaterialID) {
    ...
    Equipment(final String itemName, final int itemInitialUses, final int itemWeightPerUse, final int equipCategory,
	...
	this.initFaithPowers();
	System.arraycopy(e.faithPowersApplied, 0, this.faithPowersApplied, 0, e.faithPowersApplied.length);
	System.arraycopy(e.faithPowerName, 0, this.faithPowerName, 0, e.faithPowerName.length);
    }

    // Methods
    private final void initFaithPowers() {
	this.faithPowersApplied = new int[FaithManager.FAITHS];
	this.faithPowerName = new String[FaithManager.FAITHS];
	...
	return this.firstSlotUsed == EquipmentSlotConstants.SLOT_MAINHAND
		&& this.secondSlotUsed == EquipmentSlotConstants.SLOT_OFFHAND && !this.conditionalSlot;
    }
