...
public class CharacterSaver {
	...
	try (DataIOWriter writer = DataIOFactory.createTagWriter(characterFile, "character")) {
    ...
    public static void writeCharacter(final DataIOWriter writer, final PartyMember character) throws IOException {
	...
	final String basePath = CharacterRegistration.getBasePath();
	final String characterFile = basePath + name + FileExtensions.getCharacterExtensionWithPeriod();
