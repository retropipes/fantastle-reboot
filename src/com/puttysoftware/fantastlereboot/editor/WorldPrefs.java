...
public class WorldPrefs {
	...
	WorldPrefs.prefFrame = MainWindow.mainWindow();
	...
	WorldPrefs.useGlobalVisionRadiusOverride.setSelected(m.isGlobalVisionRadiusSet());
	WorldPrefs.useGlobalExploreExpansionRadiusOverride.setSelected(m.isGlobalExploreExpansionRadiusSet());
	WorldPrefs.globalVisionRadius.setValue(m.getGlobalVisionRadius());
	WorldPrefs.globalExploreExpansionRadius.setValue(m.getGlobalExploreExpansionRadius());
	WorldPrefs.useGlobalVisionModeOverride.setSelected(m.isGlobalVisionModeSet());
	WorldPrefs.globalVisionModeNone.setSelected(m.isGlobalVisionModeNone());
	WorldPrefs.globalVisionModeExplore.setSelected(m.isGlobalVisionModeExplore());
	WorldPrefs.globalVisionModeFieldOfView.setSelected(m.isGlobalVisionModeFieldOfView());
	WorldPrefs.globalVisionModeFixedRadius.setSelected(m.isGlobalVisionModeFixedRadius());
    }
	...
	if (WorldPrefs.useGlobalExploreExpansionRadiusOverride.isSelected()) {
	    m.setGlobalExploreExpansionRadius(WorldPrefs.globalExploreExpansionRadius.getValue());
	} else {
	...
	WorldPrefs.useGlobalVisionRadiusOverride = new JCheckBox("Enable World-Wide Vision Radius Override", false);
	...
	WorldPrefs.useGlobalVisionModeOverride = new JCheckBox("Enable World-Wide Vision Mode Override", false);
	WorldPrefs.globalVisionRadius = new JSlider(WorldPrefs.MIN_VISION_RADIUS, WorldPrefs.MAX_VISION_RADIUS,
		WorldPrefs.DEFAULT_VISION_RADIUS);
	WorldPrefs.globalVisionRadius.setLabelTable(WorldPrefs.globalVisionRadius.createStandardLabels(1));
	WorldPrefs.globalVisionRadius.setPaintLabels(true);
	WorldPrefs.globalExploreExpansionRadius = new JSlider(WorldPrefs.MIN_VISION_RADIUS,
		WorldPrefs.MAX_VISION_RADIUS, WorldPrefs.DEFAULT_VISION_RADIUS);
	WorldPrefs.globalExploreExpansionRadius
		.setLabelTable(WorldPrefs.globalExploreExpansionRadius.createStandardLabels(1));
	WorldPrefs.globalExploreExpansionRadius.setPaintLabels(true);
	WorldPrefs.globalVisionModeNone = new JCheckBox("World-Wide Vision Mode: OFF", false);
	WorldPrefs.globalVisionModeExplore = new JCheckBox("World-Wide Vision Mode: Exploring", true);
	WorldPrefs.globalVisionModeFieldOfView = new JCheckBox("World-Wide Vision Mode: Field of View", true);
	WorldPrefs.globalVisionModeFixedRadius = new JCheckBox("World-Wide Vision Mode: Fixed Radius", false);
	...
	WorldPrefs.editorPane.add(new JLabel("World-Level Exploring Expansion Radius"));
	...
	WorldPrefs.useGlobalExploreExpansionRadiusOverride.addItemListener(WorldPrefs.handler);
    ...
    private static class EventHandler implements ActionListener, ItemListener, WindowListener {
	public EventHandler() {
	    // Do nothing
	}
	...
	public void itemStateChanged(final ItemEvent e) {
		...
		if (o.getClass().equals(WorldPrefs.useGlobalVisionRadiusOverride.getClass())) {
		...
		} else if (o.getClass().equals(WorldPrefs.useGlobalExploreExpansionRadiusOverride.getClass())) {
		    final JCheckBox check = (JCheckBox) o;
		...
		} else if (o.getClass().equals(WorldPrefs.useGlobalVisionModeOverride.getClass())) {
		    final JCheckBox check = (JCheckBox) o;
		...
		} else if (o.getClass().equals(WorldPrefs.globalVisionModeNone.getClass())) {
		    final JCheckBox check = (JCheckBox) o;
		...
		} else if (o.getClass().equals(WorldPrefs.globalVisionModeExplore.getClass())) {
		    final JCheckBox check = (JCheckBox) o;
		...
		} else if (o.getClass().equals(WorldPrefs.globalVisionModeFixedRadius.getClass())) {
		    final JCheckBox check = (JCheckBox) o;
