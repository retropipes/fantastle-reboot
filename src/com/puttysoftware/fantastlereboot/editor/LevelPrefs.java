...
public class LevelPrefs {
	...
	LevelPrefs.prefFrame = MainWindow.mainWindow();
	...
	LevelPrefs.exploreExpansionRadius.setValue(m.getExploreExpansionRadiusValue());
	...
	LevelPrefs.visionModeFieldOfView.setSelected(m.isLocalVisionModeFieldOfView());
	LevelPrefs.visionModeFixedRadius.setSelected(m.isLocalVisionModeFixedRadius());
	...
	LevelPrefs.visionRadius = new JSlider(LevelPrefs.MIN_VISION_RADIUS, LevelPrefs.MAX_VISION_RADIUS,
		LevelPrefs.DEFAULT_VISION_RADIUS);
	LevelPrefs.visionRadius.setLabelTable(LevelPrefs.visionRadius.createStandardLabels(1));
	LevelPrefs.visionRadius.setPaintLabels(true);
	LevelPrefs.exploreExpansionRadius = new JSlider(LevelPrefs.MIN_VISION_RADIUS, LevelPrefs.MAX_VISION_RADIUS,
		LevelPrefs.DEFAULT_VISION_RADIUS);
	LevelPrefs.exploreExpansionRadius.setLabelTable(LevelPrefs.exploreExpansionRadius.createStandardLabels(1));
	LevelPrefs.exploreExpansionRadius.setPaintLabels(true);
	LevelPrefs.visionModeNone = new JCheckBox("World-Wide Vision Mode: OFF", false);
	LevelPrefs.visionModeExplore = new JCheckBox("World-Wide Vision Mode: Exploring", true);
	LevelPrefs.visionModeFieldOfView = new JCheckBox("World-Wide Vision Mode: Field of View", true);
	LevelPrefs.visionModeFixedRadius = new JCheckBox("World-Wide Vision Mode: Fixed Radius", false);
	...
	LevelPrefs.editorPane.add(new JLabel("Level-Wide Exploring Expansion Radius"));
	...
	public void itemStateChanged(final ItemEvent e) {
		...
		} else if (o.getClass().equals(LevelPrefs.visionModeExplore.getClass())) {
		    final JCheckBox check = (JCheckBox) o;
		...
		} else if (o.getClass().equals(LevelPrefs.visionModeFixedRadius.getClass())) {
		    final JCheckBox check = (JCheckBox) o;
