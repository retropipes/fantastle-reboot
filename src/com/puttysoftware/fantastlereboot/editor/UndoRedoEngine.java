...
class UndoRedoEngine {
	...
	return this.destX != -1 && this.destY != -1 && this.destZ != -1 && this.destW != -1 && this.destE != -1;
    }
    ...
    public void updateUndoHistory(final FantastleObjectModel obj, final int x, final int y, final int z, final int w,
	    final int e) {
	this.undoHistory.push(obj, x, y, z, w, e);
    }

    public void updateRedoHistory(final FantastleObjectModel obj, final int x, final int y, final int z, final int w,
	    final int e) {
	...
	public Link(final FantastleObjectModel obj, final int x, final int y, final int z, final int w, final int e) {
	    this.mo = obj;
	    this.coordX = x;
	    this.coordY = y;
	    this.coordZ = z;
	...
	public void insertFirst(final FantastleObjectModel obj, final int x, final int y, final int z, final int w,
		final int e) {
	...
	public void push(final FantastleObjectModel obj, final int x, final int y, final int z, final int w,
		final int e) {
