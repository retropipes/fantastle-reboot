...
public class GenerateTask extends Thread {
    ...
    public void run() {
	try {
	    this.generateFrame = MainWindow.mainWindow();
	    ...
	    gameWorld.addLevel(World.getMaxRows(), World.getMaxColumns(), World.getMaxFloors());
		...
		do {
		    ...
		    startC = rC.generate();
		    startF = rF.generate();
		} while (gameWorld.getCell(startR, startC, startF, Layers.OBJECT).isSolid());
