...
public class MenuManager {
    ...
    private JMenuItem editUndo, editRedo, editPreferences, editCutLevel, editCopyLevel, editPasteLevel,
	    editInsertLevelFromClipboard, editClearHistory, editGoTo, editUpOneFloor, editDownOneFloor, editUpOneLevel,
	    editDownOneLevel, editAddLevel, editRemoveLevel, editResizeLevel, editToggleLayer, editWorldPreferences,
	    editLevelPreferences;
    private JMenuItem playNewGame, playPlay, playEdit, playSuspend, playResume, playRegisterCharacter,
	    playUnregisterCharacter, playRemoveCharacter;
    private JMenuItem gameEquipment, gameInventory, gameUse, gameReset, gameEditNote, gameViewStats, gameChangeLeader;
    ...
    private KeyStroke editPreferencesAccel, editUndoAccel, editRedoAccel, editCutLevelAccel, editCopyLevelAccel,
	    editPasteLevelAccel, editInsertLevelFromClipboardAccel, editClearHistoryAccel, editGoToAccel,
	...
	public void actionPerformed(final ActionEvent e) {
		...
		if (cmd.equals("New...")) {
		    ...
		    final int res = CommonDialogs.showConfirmDialog("Are you sure you want to clear the history?",
			    "Editor");
