...
public class AboutDialog implements AboutHandler {
	...
	this.logoPane.add(
		new JLabel("", UserInterfaceImageLoader.load(UserInterfaceImageIndex.MINI_LOGO), SwingConstants.LEFT));
	...
	this.textPane.add(new JLabel("Web Site: https://puttysoftware.github.com/fantastle-reboot/"));
