...
class GameGUI {
	...
	GameGUI.outputFrame = MainWindow.mainWindow();
	...
	GameGUI.borderPane.add(EffectManager.getEffectMessageJPanel(), BorderLayout.SOUTH);
    }
	...
	GameGUI.outputPane.setPreferredSize(new Dimension(vSize * gSize, vSize * gSize));
    }
