...
public class StatisticsViewer {
	...
	if (leader != null) {
		...
		if (x == StatConstants.STAT_HIT || x == StatConstants.STAT_EVADE) {
		    ...
		    StatisticsViewer.statisticsValues[x]
			    .setText(" " + StatConstants.STAT_NAMES[x] + ": " + fmtVal + "%  ");
		} else {
		    StatisticsViewer.statisticsValues[x]
	...
	if (!StatisticsViewer.inited) {
	    StatisticsViewer.statisticsFrame = MainWindow.mainWindow();
	    ...
	    StatisticsViewer.btnOK.addActionListener(_ -> Game.showOutput());
	    ...
	    StatisticsViewer.statisticsFrame.attachContent(StatisticsViewer.statisticsPane);
