...
class StatGUI {
	...
	final BufferedImageIcon mpImage = EffectImageLoader.load(EffectImageIndex.MAGIC);
	StatGUI.mpLabel.setIcon(mpImage);
	final BufferedImageIcon goldImage = EffectImageLoader.load(EffectImageIndex.MONEY);
	StatGUI.goldLabel.setIcon(goldImage);
	final BufferedImageIcon attackImage = EffectImageLoader.load(EffectImageIndex.MELEE_ATTACK);
	StatGUI.attackLabel.setIcon(attackImage);
	final BufferedImageIcon defenseImage = EffectImageLoader.load(EffectImageIndex.DEFENSE);
	StatGUI.defenseLabel.setIcon(defenseImage);
	final BufferedImageIcon xpImage = EffectImageLoader.load(EffectImageIndex.EXPERIENCE);
	StatGUI.xpLabel.setIcon(xpImage);
	final BufferedImageIcon levelImage = EffectImageLoader.load(EffectImageIndex.CREATURE_LEVEL);
