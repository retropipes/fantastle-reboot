...
public final class Game {
    ...
    public static void updatePositionRelative(final int dirX, final int dirY, final int dirZ) {
	...
	if (FileStateManager.getLoaded()) {
		...
		WorldManager.getWorld().switchLevel(WorldManager.getWorld().getStartLevel());
