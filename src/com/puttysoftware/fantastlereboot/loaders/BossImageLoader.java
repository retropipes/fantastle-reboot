...
public class BossImageLoader {
	...
	final String imageExt = BossImageLoader.fileExtensions.getProperty("images");
	final BossImageIndex image = BossImageIndex.BOSS;
	final String name = "/assets/images/boss/" + BossImageLoader.allFilenames[image.ordinal()] + imageExt;
	return DianeImageLoader.load(name, BossImageLoader.class.getResource(name));
    }

    public static void cacheAll() {
	BossImageLoader.allFilenames = DataLoader.loadBossImageData();
	try (InputStream stream = BossImageLoader.class
	...
	final BossImageIndex image = BossImageIndex.BOSS;
	final String name = "/assets/images/boss/" + BossImageLoader.allFilenames[image.ordinal()] + imageExt;
	DianeImageLoader.load(name, BossImageLoader.class.getResource(name));
    }
}
