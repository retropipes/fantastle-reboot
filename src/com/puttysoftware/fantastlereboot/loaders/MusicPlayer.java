...
public class MusicPlayer {
	...
	if (MusicPlayer.allFilenames == null && MusicPlayer.fileExtensions == null) {
	    ...
	    try (InputStream stream = MusicPlayer.class
	...
	if (music == MusicIndex.DUNGEON || music == MusicIndex._DUNGEON_RANDOM_2
		|| music == MusicIndex._DUNGEON_RANDOM_3 || music == MusicIndex._DUNGEON_RANDOM_4) {
	...
	if (Prefs.isMusicGroupEnabled(group)) {
		...
		MusicPlayer.MUSIC = OggLoader.loadResource(MusicPlayer.class.getResource("/assets/music/" + filename));
