...
public class DataLoader {
	...
	try (final ResourceStreamReader rsr = new ResourceStreamReader(DataLoader.class.getResourceAsStream(
		"/assets/data/job/" + name + FileExtensions.getInternalDataExtensionWithPeriod()))) {
	    // Fetch data
	...
	try (final ResourceStreamReader rsr = new ResourceStreamReader(DataLoader.class.getResourceAsStream(
		"/assets/data/faith/names" + FileExtensions.getInternalDataExtensionWithPeriod()))) {
	    // Fetch data
	...
	try (final ResourceStreamReader rsr = new ResourceStreamReader(DataLoader.class.getResourceAsStream(
		"/assets/data/faith/colors/" + name + FileExtensions.getInternalDataExtensionWithPeriod()))) {
	    // Fetch data
	...
	final String name = Integer.toString(f);
	try (final ResourceStreamReader rsr = new ResourceStreamReader(DataLoader.class.getResourceAsStream(
		"/assets/data/faith/numerator/" + name + FileExtensions.getInternalDataExtensionWithPeriod()))) {
	    // Fetch data
	...
	final String name = Integer.toString(f);
	try (final ResourceStreamReader rsr = new ResourceStreamReader(DataLoader.class.getResourceAsStream(
		"/assets/data/faith/denominator/" + name + FileExtensions.getInternalDataExtensionWithPeriod()))) {
	    // Fetch data
	    final int[] data = new int[FaithManager.FAITHS];
	    for (int x = 0; x < data.length; x++) {
		data[x] = rsr.readInt();
	...
	try (final ResourceStreamReader rsr = new ResourceStreamReader(DataLoader.class.getResourceAsStream(
		"/assets/data/names/given" + FileExtensions.getInternalDataExtensionWithPeriod()))) {
	    // Fetch data
	...
	try (final ResourceStreamReader rsr = new ResourceStreamReader(DataLoader.class.getResourceAsStream(
		"/assets/data/names/family" + FileExtensions.getInternalDataExtensionWithPeriod()))) {
	    // Fetch data
	    final ArrayList<String> data = new ArrayList<>();
	    String raw = "0";
	    while (raw != null) {
	...
	try (final ResourceStreamReader rsr = new ResourceStreamReader(DataLoader.class.getResourceAsStream(
		"/assets/data/monster/monsternames" + FileExtensions.getInternalDataExtensionWithPeriod()))) {
	    // Fetch data
	    final ArrayList<String> data = new ArrayList<>();
	    String raw = "0";
	    while (raw != null) {
	...
	try (final ResourceStreamReader rsr = new ResourceStreamReader(DataLoader.class.getResourceAsStream(
		"/assets/data/race/" + name + FileExtensions.getInternalDataExtensionWithPeriod()))) {
	    // Fetch data
	...
	try (final ResourceStreamReader rsr = new ResourceStreamReader(DataLoader.class.getResourceAsStream(
		"/assets/data/sounds/files" + FileExtensions.getInternalDataExtensionWithPeriod()))) {
	    // Fetch data
	    final ArrayList<String> data = new ArrayList<>();
	    String raw = "0";
	    while (raw != null) {
	...
	try (final ResourceStreamReader rsr = new ResourceStreamReader(DataLoader.class.getResourceAsStream(
		"/assets/data/objects/actions" + FileExtensions.getInternalDataExtensionWithPeriod()))) {
	    // Fetch data
	...
	try (final ResourceStreamReader rsr = new ResourceStreamReader(DataLoader.class.getResourceAsStream(
		"/assets/data/objects/" + name + FileExtensions.getInternalDataExtensionWithPeriod()))) {
	    // Fetch data
	    ...
	    FantastleReboot.exceptionWithMessage(e, "Action ID " + actionID + " has no addon data file.");
	    return null;
	}
    }
	...
	try (final ResourceStreamReader rsr = new ResourceStreamReader(DataLoader.class.getResourceAsStream(
		"/assets/data/images/attributes" + FileExtensions.getInternalDataExtensionWithPeriod()))) {
	    // Fetch data
	    final ArrayList<String> data = new ArrayList<>();
	    String raw = "0";
	    while (raw != null) {
	...
	try (final ResourceStreamReader rsr = new ResourceStreamReader(DataLoader.class.getResourceAsStream(
		"/assets/data/images/boss" + FileExtensions.getInternalDataExtensionWithPeriod()))) {
	    // Fetch data
	    final ArrayList<String> data = new ArrayList<>();
	    String raw = "0";
	    while (raw != null) {
	...
	try (final ResourceStreamReader rsr = new ResourceStreamReader(DataLoader.class.getResourceAsStream(
		"/assets/data/images/effects" + FileExtensions.getInternalDataExtensionWithPeriod()))) {
	    // Fetch data
	    final ArrayList<String> data = new ArrayList<>();
	    String raw = "0";
	    while (raw != null) {
	...
	try (final ResourceStreamReader rsr = new ResourceStreamReader(DataLoader.class.getResourceAsStream(
		"/assets/data/images/objects" + FileExtensions.getInternalDataExtensionWithPeriod()))) {
	    // Fetch data
	    final ArrayList<String> data = new ArrayList<>();
	    String raw = "0";
	    while (raw != null) {
	...
	try (final ResourceStreamReader rsr = new ResourceStreamReader(DataLoader.class
		.getResourceAsStream("/assets/data/images/ui" + FileExtensions.getInternalDataExtensionWithPeriod()))) {
	    // Fetch data
	    final ArrayList<String> data = new ArrayList<>();
	    String raw = "0";
	    while (raw != null) {
