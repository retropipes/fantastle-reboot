...
public class OverseerSpellBook extends SpellBook {
    // Constructor
    public OverseerSpellBook() {
	super();
	...
	final Spell spell0 = new Spell(spell0Effect, 1, BattleTarget.SELF, SoundIndex.FOCUS);
	...
	final Spell spell1 = new Spell(spell1Effect, 3, BattleTarget.ENEMY, SoundIndex.SLICE);
	...
	final Spell spell2 = new Spell(spell2Effect, 6, BattleTarget.SELF, SoundIndex.HEAL);
	...
	final Spell spell3 = new Spell(spell3Effect, 10, BattleTarget.ENEMY, SoundIndex.DRAIN);
	...
	final Spell spell4 = new Spell(spell4Effect, 25, BattleTarget.SELF, SoundIndex.BUFF_2);
	...
	final Spell spell5 = new Spell(spell5Effect, 50, BattleTarget.ENEMY, SoundIndex.COOL_OFF);
	this.addUnknownSpell(spell5);
    }

    @Override
    public int getID() {
	return JobConstants.OVERSEER;
    }
}
