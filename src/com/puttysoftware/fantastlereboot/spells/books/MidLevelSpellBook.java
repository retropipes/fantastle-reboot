...
public class MidLevelSpellBook extends SpellBook {
	...
	super();
	final DamageEffect spell0Effect = new DamageEffect("Poisoned", 3, 5, Effect.DEFAULT_SCALE_FACTOR,
	...
	final HealingEffect spell1Effect = new HealingEffect("Recover", 15, 1, Effect.DEFAULT_SCALE_FACTOR,
	...
	spell2Effect.setEffect(Effect.EFFECT_MULTIPLY, 0.8, Effect.DEFAULT_SCALE_FACTOR, StatConstants.STAT_NONE);
	...
	spell3Effect.setEffect(Effect.EFFECT_MULTIPLY, 0.8, Effect.DEFAULT_SCALE_FACTOR, StatConstants.STAT_NONE);
	...
	spell4Effect.setEffect(Effect.EFFECT_MULTIPLY, 1.25, Effect.DEFAULT_SCALE_FACTOR, StatConstants.STAT_NONE);
	...
	spell5Effect.setEffect(Effect.EFFECT_MULTIPLY, 1.25, Effect.DEFAULT_SCALE_FACTOR, StatConstants.STAT_NONE);
