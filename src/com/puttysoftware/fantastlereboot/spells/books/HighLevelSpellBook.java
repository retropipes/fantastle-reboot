...
public class HighLevelSpellBook extends SpellBook {
	...
	super();
	final DamageEffect spell0Effect = new DamageEffect("Dangerously Poisoned", 5, 8, Effect.DEFAULT_SCALE_FACTOR,
		StatConstants.STAT_NONE, 0.5);
	spell0Effect.setMessage(Effect.MESSAGE_INITIAL, "The enemy breathes highly poisonous breath at you!");
	spell0Effect.setMessage(Effect.MESSAGE_SUBSEQUENT, "You lose quite a bit of health from being poisoned!");
	...
	final HealingEffect spell1Effect = new HealingEffect("Mega Recover", 50, 1, Effect.DEFAULT_SCALE_FACTOR,
		StatConstants.STAT_NONE, Effect.DEFAULT_DECAY_RATE);
	spell1Effect.setMessage(Effect.MESSAGE_INITIAL, "The enemy applies a large bandage to its wounds!");
	...
	spell2Effect.setEffect(Effect.EFFECT_MULTIPLY, 0.6, Effect.DEFAULT_SCALE_FACTOR, StatConstants.STAT_NONE);
	...
	spell3Effect.setEffect(Effect.EFFECT_MULTIPLY, 0.6, Effect.DEFAULT_SCALE_FACTOR, StatConstants.STAT_NONE);
	...
	spell4Effect.setEffect(Effect.EFFECT_MULTIPLY, 1.5, Effect.DEFAULT_SCALE_FACTOR, StatConstants.STAT_NONE);
	spell4Effect.setMessage(Effect.MESSAGE_INITIAL, "The enemy charges its weapon with super power!");
	spell4Effect.setMessage(Effect.MESSAGE_SUBSEQUENT, "The enemy's attack is significantly increased!");
	...
	spell5Effect.setEffect(Effect.EFFECT_MULTIPLY, 1.5, Effect.DEFAULT_SCALE_FACTOR, StatConstants.STAT_NONE);
	spell5Effect.setMessage(Effect.MESSAGE_INITIAL, "The enemy charges its armor with super power!");
	spell5Effect.setMessage(Effect.MESSAGE_SUBSEQUENT, "The enemy's defense is significantly increased!");
