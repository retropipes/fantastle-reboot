...
public class LowLevelSpellBook extends SpellBook {
	...
	super();
	final DamageEffect spell0Effect = new DamageEffect("Slightly Poisoned", 1, 3, Effect.DEFAULT_SCALE_FACTOR,
		StatConstants.STAT_NONE, Effect.DEFAULT_DECAY_RATE);
	spell0Effect.setMessage(Effect.MESSAGE_INITIAL, "The enemy breathes slightly poisonous breath at you!");
	spell0Effect.setMessage(Effect.MESSAGE_SUBSEQUENT, "You lose a little health from being poisoned!");
	...
	final HealingEffect spell1Effect = new HealingEffect("Minor Recover", 3, 1, Effect.DEFAULT_SCALE_FACTOR,
		StatConstants.STAT_NONE, Effect.DEFAULT_DECAY_RATE);
	spell1Effect.setMessage(Effect.MESSAGE_INITIAL, "The enemy applies a small bandage to its wounds!");
	spell1Effect.setMessage(Effect.MESSAGE_SUBSEQUENT, "The enemy regains a little health!");
	...
	spell2Effect.setEffect(Effect.EFFECT_MULTIPLY, 0.9, Effect.DEFAULT_SCALE_FACTOR, StatConstants.STAT_NONE);
	spell2Effect.setMessage(Effect.MESSAGE_INITIAL, "The enemy drains your weapon of a little of its power!");
	spell2Effect.setMessage(Effect.MESSAGE_SUBSEQUENT, "Your attack is slightly decreased!");
	...
	spell3Effect.setEffect(Effect.EFFECT_MULTIPLY, 0.9, Effect.DEFAULT_SCALE_FACTOR, StatConstants.STAT_NONE);
	spell3Effect.setMessage(Effect.MESSAGE_INITIAL, "The enemy drains your armor of a little of its power!");
	spell3Effect.setMessage(Effect.MESSAGE_SUBSEQUENT, "Your defense is slightly decreased!");
	...
	spell4Effect.setEffect(Effect.EFFECT_MULTIPLY, 1.1, Effect.DEFAULT_SCALE_FACTOR, StatConstants.STAT_NONE);
	spell4Effect.setMessage(Effect.MESSAGE_INITIAL, "The enemy charges its weapon with power!");
	spell4Effect.setMessage(Effect.MESSAGE_SUBSEQUENT, "The enemy's attack is slightly increased!");
	...
	spell5Effect.setEffect(Effect.EFFECT_MULTIPLY, 0.9, Effect.DEFAULT_SCALE_FACTOR, StatConstants.STAT_NONE);
	spell5Effect.setMessage(Effect.MESSAGE_INITIAL, "The enemy charges its armor with power!");
	spell5Effect.setMessage(Effect.MESSAGE_SUBSEQUENT, "The enemy's defense is slightly increased!");
