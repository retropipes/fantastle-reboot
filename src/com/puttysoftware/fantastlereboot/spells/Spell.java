...
public class Spell {
    ...
    // Constructors
    public Spell(final Effect newEffect, final int newCost, final BattleTarget newTarget) {
    ...
    public Spell(final Effect newEffect, final int newCost, final BattleTarget newTarget, final SoundIndex sfx) {
	this.effect = newEffect;
	this.cost = newCost;
	this.target = newTarget;
