...
public final class ColorShaders {
	...
	if (ColorShaders.DOOR == null) {
	    ColorShaders.DOOR = new ColorShader("door", new Color(191, 95, 47, 255));
	}
	...
	if (ColorShaders.WOODEN == null) {
	    ColorShaders.WOODEN = new ColorShader("wooden", new Color(127, 63, 0, 255));
	}
	...
	if (ColorShaders.SCORCH == null) {
	    ColorShaders.SCORCH = new ColorShader("scorch", new Color(255, 0, 0, 255));
	}
	...
	if (ColorShaders.FREEZE == null) {
	    ColorShaders.FREEZE = new ColorShader("freeze", new Color(0, 255, 255, 255));
	}
	...
	if (ColorShaders.SHADOW == null) {
	    ColorShaders.SHADOW = new ColorShader("shadow", new Color(47, 47, 47, 255));
	}
	...
	if (ColorShaders.VORTEX == null) {
	    ColorShaders.VORTEX = new ColorShader("vortex", new Color(0, 255, 0, 255));
	}
	...
	if (ColorShaders.CHARGE == null) {
	    ColorShaders.CHARGE = new ColorShader("charge", new Color(255, 255, 0, 255));
	}
	...
	if (ColorShaders.SACRED == null) {
	    ColorShaders.SACRED = new ColorShader("sacred", new Color(223, 223, 223, 255));
	}
	...
	if (ColorShaders.BEAUTY == null) {
	    ColorShaders.BEAUTY = new ColorShader("beauty", new Color(255, 0, 255, 255));
	}
	...
	if (ColorShaders.LIQUID == null) {
	    ColorShaders.LIQUID = new ColorShader("liquid", new Color(0, 0, 255, 255));
	}
	...
	if (ColorShaders.NORMAL == null) {
	    ColorShaders.NORMAL = new ColorShader("normal", new Color(127, 127, 127, 255));
	}
	...
	if (ColorShaders.POISON == null) {
	    ColorShaders.POISON = new ColorShader("poison", new Color(63, 0, 127, 255));
	}
	...
	if (ColorShaders.PLASMA == null) {
	    ColorShaders.PLASMA = new ColorShader("plasma", new Color(63, 255, 127, 255));
	}
	...
	if (ColorShaders.MAGNET == null) {
	    ColorShaders.MAGNET = new ColorShader("magnet", new Color(255, 63, 0, 255));
	}
