...
public final class GameObjects {
	...
	final FantastleObjectModel[] allObjects = { new ArmorShop(), new BankShop(), new OpenSpace(), new Nothing(),
		new BonusShop(), new ElementalShop(), new HealShop(), new Ice(), new ItemShop(), new RegenerateShop(),
		new SealingWall(), new NecklaceShop(), new SpellShop(), new Tile(), new Wall(), new WeaponShop(),
		new Wall(), new StairsUp(), new StairsDown(), new Pit(), new Spring(), new SuperPit(),
	...
	GameObjects.allShopActionList = DataLoader.loadObjectActionAddonData(FantastleObjectActions.SHOP);
	...
	return GameObjects.allActionList[obj.getUniqueID()].get(FantastleObjectActions.REPLACE_SELF);
    }

    public static FantastleObjectModel replacesSelfWith(final FantastleObjectModel obj) {
	return GameObjects.getNewInstanceByUniqueID(GameObjects.allSelfReplacementActionList[obj.getUniqueID()]);
    }

    public static boolean sendsDown(final FantastleObjectModel obj) {
	return GameObjects.allActionList[obj.getUniqueID()].get(FantastleObjectActions.DOWN_1_FLOOR);
    }

    public static boolean sendsUp(final FantastleObjectModel obj) {
	return GameObjects.allActionList[obj.getUniqueID()].get(FantastleObjectActions.UP_1_FLOOR);
    }

    public static boolean sendsDown2(final FantastleObjectModel obj) {
	return GameObjects.allActionList[obj.getUniqueID()].get(FantastleObjectActions.DOWN_2_FLOORS);
    }

    public static boolean sendsUp2(final FantastleObjectModel obj) {
	return GameObjects.allActionList[obj.getUniqueID()].get(FantastleObjectActions.UP_2_FLOORS);
    }

    public static boolean sendsNext(final FantastleObjectModel obj) {
	return GameObjects.allActionList[obj.getUniqueID()].get(FantastleObjectActions.NEXT_LEVEL);
    }

    public static boolean sendsPrevious(final FantastleObjectModel obj) {
	return GameObjects.allActionList[obj.getUniqueID()].get(FantastleObjectActions.PREVIOUS_LEVEL);
    }

    public static boolean sendsToShop(final FantastleObjectModel obj) {
	return GameObjects.allActionList[obj.getUniqueID()].get(FantastleObjectActions.SHOP);
    }
	...
	return GameObjects.allObjectList.toArray(new FantastleObjectModel[GameObjects.allObjectList.size()]);
    }
    ...
    public static FantastleObjectModel[] getAllWithoutPrerequisiteAndNotRequired(final int layer) {
	final FantastleObjectModel[] objects = GameObjects.getAllObjects();
    ...
    public static FantastleObjectModel readObject(final DataIOReader reader, final int formatVersion)
	    throws IOException {
	final FantastleObjectModel[] objects = GameObjects.getAllObjects();
    ...
    public static FantastleObjectModel readSavedObject(final DataIOReader reader, final int UID,
