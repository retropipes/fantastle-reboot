...
import org.retropipes.diane.asset.image.ImageShader;

import com.puttysoftware.fantastlereboot.assets.ObjectImageIndex;
import com.puttysoftware.fantastlereboot.loaders.ObjectImageLoader;

class ObjectAppearance extends Appearance {
    public ObjectAppearance(final String name, final ObjectImageIndex inImageIndex) {
	super(name, inImageIndex);
    }

    public ObjectAppearance(final String name, final ObjectImageIndex inImageIndex, final ColorShader inShader) {
	...
	BufferedImageIcon image = ObjectImageLoader.load(this.getWhichObjectImage());
	if (this.hasShading()) {
