...
public class MapBattleStats {
	...
	final BufferedImageIcon nameImage = EffectImageLoader.load(EffectImageIndex.CREATURE_ID);
	this.nameLabel.setIcon(nameImage);
	final BufferedImageIcon teamImage = EffectImageLoader.load(EffectImageIndex.CREATURE_TEAM);
	...
	final BufferedImageIcon attImage = EffectImageLoader.load(EffectImageIndex.MELEE_ATTACK);
	this.attLabel.setIcon(attImage);
	final BufferedImageIcon defImage = EffectImageLoader.load(EffectImageIndex.DEFENSE);
	this.defLabel.setIcon(defImage);
	final BufferedImageIcon apImage = EffectImageLoader.load(EffectImageIndex.ACTIONS_00);
