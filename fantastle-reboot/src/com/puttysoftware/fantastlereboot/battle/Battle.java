...
import com.puttysoftware.fantastlereboot.creatures.Monster;
...
import com.puttysoftware.fantastlereboot.resourcemanagers.MusicManager;
...
public class Battle implements BattleResults, MoveTypes {
    ...
    public final void battleDone() {
        ...
        FantastleReboot.getApplication().getGameManager().showOutput();
