...
public class BossSpellBook extends SpellBook {
  ...
  public BossSpellBook() {
    super();
    final DamageEffect spell0Effect = new DamageEffect("Lethally Poisoned", 10,
        10, Effect.DEFAULT_SCALE_FACTOR, StatConstants.STAT_NONE, 1);
    ...
    final HealingEffect spell1Effect = new HealingEffect("Ultra Recover", 100,
