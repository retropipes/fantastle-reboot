...
public class HighLevelSpellBook extends SpellBook {
  ...
  public HighLevelSpellBook() {
    super();
    final DamageEffect spell0Effect = new DamageEffect("Dangerously Poisoned",
        5, 8, Effect.DEFAULT_SCALE_FACTOR, StatConstants.STAT_NONE, 0.5);
    ...
    final HealingEffect spell1Effect = new HealingEffect("Mega Recover", 50, 1,
