...
public class LowLevelSpellBook extends SpellBook {
  ...
  public LowLevelSpellBook() {
    super();
    final DamageEffect spell0Effect = new DamageEffect("Slightly Poisoned", 1,
        3, Effect.DEFAULT_SCALE_FACTOR, StatConstants.STAT_NONE,
    ...
    final HealingEffect spell1Effect = new HealingEffect("Minor Recover", 3, 1,
