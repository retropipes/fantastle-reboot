...
public class ObjectImageLoader {
    ...
    static BufferedImageIcon loadUncached(final String name) {
        try {
            final URL url = ObjectImageLoader.class
                    .getResource("/assets/images/objects/" + name);
    ...
    public static void viewCache() {
        ...
        final JFrame viewFrame = new JFrame("Object Image Cache Viewer");
    ...
    private static class ImageCache {
        ...
        public static BufferedImageIcon getCachedImage(final String name) {
            ...
            BufferedImageIcon newImage = ObjectImageLoader.loadUncached(name);
