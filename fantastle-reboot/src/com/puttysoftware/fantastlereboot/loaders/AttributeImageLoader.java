...
public class AttributeImageLoader {
    ...
    static BufferedImageIcon loadUncached(final String name) {
        try {
            final URL url = AttributeImageLoader.class
                    .getResource("/assets/images/attributes/" + name);
    ...
    public static void viewCache() {
        ...
        final JFrame viewFrame = new JFrame("Attribute Image Cache Viewer");
    ...
    private static class ImageCache {
        ...
        public static BufferedImageIcon getCachedImage(final String name) {
            ...
            BufferedImageIcon newImage = AttributeImageLoader
                    .loadUncached(name);
