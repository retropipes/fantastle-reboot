...
public class AvatarImageLoader {
    ...
    static BufferedImageIcon loadUncached(final String name) {
        try {
            final URL url = AvatarImageLoader.class
                    .getResource("/assets/images/avatars/" + name);
    ...
    public static void viewCache() {
        ...
        final JFrame viewFrame = new JFrame("Avatar Image Cache Viewer");
    ...
    private static class ImageCache {
        ...
        public static BufferedImageIcon getCachedImage(final String name) {
            ...
            BufferedImageIcon newImage = AvatarImageLoader.loadUncached(name);
