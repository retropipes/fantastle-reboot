...
import net.worldwizard.fantastle5.creatures.StatGUI;
import net.worldwizard.fantastle5.effects.EffectConstants;
import net.worldwizard.fantastle5.effects.EffectManager;
...
import net.worldwizard.fantastle5.objects.AnnihilationWand;
import net.worldwizard.fantastle5.objects.DisarmTrapWand;
import net.worldwizard.fantastle5.objects.Empty;
import net.worldwizard.fantastle5.objects.EmptyVoid;
import net.worldwizard.fantastle5.objects.FinishMakingWand;
import net.worldwizard.fantastle5.objects.Player;
import net.worldwizard.fantastle5.objects.TeleportWand;
import net.worldwizard.fantastle5.objects.Wall;
import net.worldwizard.fantastle5.objects.WallBreakingWand;
import net.worldwizard.fantastle5.objects.WallMakingWand;
...
public class GameManager implements EffectConstants {
    ...
    public void doRemoteAction(final int x, final int y, final int z,
        ...
        final MazeObject acted = Fantastle5.getApplication().getMazeManager()
    ...
    private class EventHandler implements KeyListener, WindowListener,
        ...
        public void keyPressed(final KeyEvent e) {
            if (!GameManager.this.arrowActive) {
                if (!Fantastle5.getApplication().getPrefsManager().oneMove()) {
                    if (e.isAltDown()) {
                        this.handleArrows(e);
                    } else {
