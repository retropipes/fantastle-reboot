...
import net.worldwizard.fantastle5.generic.GenericTransientObject;
import net.worldwizard.fantastle5.generic.MazeObject;
import net.worldwizard.fantastle5.maze.Maze;
import net.worldwizard.fantastle5.objects.Arrow;
import net.worldwizard.fantastle5.objects.Empty;
import net.worldwizard.fantastle5.objects.IceArrow;
