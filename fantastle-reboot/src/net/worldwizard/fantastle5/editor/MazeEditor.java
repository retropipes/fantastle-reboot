 ...
 */
package net.worldwizard.fantastle5.editor;
...
import net.worldwizard.fantastle5.game.GameManager;
...
import net.worldwizard.fantastle5.maze.Maze5;
import net.worldwizard.fantastle5.maze.MazeManager;
import net.worldwizard.fantastle5.objects.Empty;
import net.worldwizard.fantastle5.objects.EmptyVoid;
import net.worldwizard.fantastle5.objects.FinishTo;
import net.worldwizard.fantastle5.objects.InvisibleOneShotTeleport;
import net.worldwizard.fantastle5.objects.InvisibleTeleport;
import net.worldwizard.fantastle5.objects.MetalButton;
import net.worldwizard.fantastle5.objects.OneShotTeleport;
import net.worldwizard.fantastle5.objects.RandomInvisibleOneShotTeleport;
import net.worldwizard.fantastle5.objects.RandomInvisibleTeleport;
import net.worldwizard.fantastle5.objects.RandomOneShotTeleport;
import net.worldwizard.fantastle5.objects.RandomTeleport;
import net.worldwizard.fantastle5.objects.StairsDown;
import net.worldwizard.fantastle5.objects.StairsUp;
import net.worldwizard.fantastle5.objects.Teleport;
import net.worldwizard.fantastle5.objects.TreasureChest;
import net.worldwizard.fantastle5.objects.TwoWayTeleport;
...
public class MazeEditor {
    ...
    public void editObject(final int x, final int y) {
        ...
        try {
            app.getGameManager().setSavedMazeObject(
                    app.getMazeManager()
                            .getMaze()
                            .getCell(gridX, gridY,
                                    this.elMgr.getEditorLocationZ(),
        ...
        try {
            ...
            app.getMazeManager()
                    .getMaze()
                    .setCell(app.getGameManager().getSavedMazeObject(), gridX,
            ...
            if (!mo.defersSetProperties()) {
                ...
                if (mo2 == null) {
                    ...
                    this.updateUndoHistory(app.getGameManager()
                            .getSavedMazeObject(), gridX, gridY, this.elMgr
    ...
    private void checkStairPair(final int z, final int w) {
        ...
        final MazeObject mo1 = app
                ...
                .getCell(this.elMgr.getEditorLocationX(),
                        this.elMgr.getEditorLocationY(), z, w,
                        Maze.LAYER_OBJECT);
    ...
    private void checkTwoWayTeleportPair(final int z, final int w) {
        ...
        if (name1.equals("Two-Way Teleport")) {
            ...
            final MazeObject mo2 = app.getMazeManager().getMaze()
                    .getCell(destX, destY, destZ, destW, Maze.LAYER_OBJECT);
            name2 = mo2.getName();
    ...
    private static void unpairTwoWayTeleport(final int destX, final int destY,
        ...
        app.getMazeManager()
                .getMaze()
                .setCell(new Empty(), destX, destY, destZ, destW,
                        Maze.LAYER_OBJECT);
    }
    ...
    public void setPlayerLocation() {
        ...
        app.getGameManager()
                .getPlayerManager()
                .setPlayerLocation(this.elMgr.getEditorLocationX(),
                        this.elMgr.getEditorLocationY(),
                        this.elMgr.getEditorLocationZ(),
                        this.elMgr.getEditorLocationW());
        app.getMazeManager()
                .getMaze()
                .setStartRow(this.elMgr.getEditorLocationW(),
                        this.elMgr.getEditorLocationY());
        app.getMazeManager()
                .getMaze()
                .setStartColumn(this.elMgr.getEditorLocationW(),
                        this.elMgr.getEditorLocationX());
        app.getMazeManager()
                .getMaze()
                .setStartFloor(this.elMgr.getEditorLocationW(),
                        this.elMgr.getEditorLocationZ());
    }
    ...
    public void exitEditor() {
        ...
        Fantastle5.getApplication().getGUIManager().showGUI();
    }
