...
public final class Column extends Table {
  ...
  public Row data(int j) { return data(new Row(), j); }
  public Row data(Row obj, int j) { int o = __offset(4); return o != 0 ? obj.__assign(__indirect(__vector(o) + j * 4), bb) : null; }
  ...
  public static int createColumn(FlatBufferBuilder builder,
    ...
    Column.addData(builder, dataOffset);
    Column.addWraparound(builder, wraparound);
